...
<head>
    ...
    <!-- Title Page-->
    <title>Internal Management System of Xanh Taxi One Member Limited Liability Company || Manage Auto/Taxi Entry</title>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <h3>Internal Management System of Xanh Taxi One Member Limited Liability Company - Last 7 Days Autos/ Taxies Entry Details</h3>
                            <hr />
...
<?php
$ret=mysqli_query($con,"select * from tblstandentry where  date(EntryDate)>=(DATE(NOW()) - INTERVAL 7 DAY)");
$cnt=1;
